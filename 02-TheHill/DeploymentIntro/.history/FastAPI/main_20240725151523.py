...
from pydantic import BaseModel, t_validator, ValidationError
...
class SalaryData(BaseModel):
    ...
    def check_all_fields_present(cls, values):
        ...
        if missing_fields:
            raise HTTPException(status_code=400, detail=f"3 fields expected (salary, bonus, taxes). You forgot: {missing_fields}.")
        return values
